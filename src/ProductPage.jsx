  ...
  return (
    <main className="product-page">
      <nav className="product-nav" aria-label="主导航">
        <a className="product-logo" href="#top" aria-label="Luma 首页"><span className="logo-orb" aria-hidden="true"><span /></span><span>Luma</span></a>
      ...
      <footer><a className="product-logo" href="#top"><span className="logo-orb" aria-hidden="true"><span /></span><span>Luma</span></a><span>Made for quiet desktops.</span><a href={releasesUrl} target="_blank" rel="noreferrer">GitHub Releases <ArrowUpRight size={14} /></a></footer>
    </main>
  );
}
